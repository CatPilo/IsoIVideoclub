...
public class Agente {
	...
	public Vector<Object> select(String SQL) throws SQLException,Exception{
	    ...
	    */	
		Vector<Object> registers = new Vector<Object>();
		conectar();
		Statement stmt = mBD.createStatement();
		ResultSet res = stmt.executeQuery(SQL);
		while(res.next()) {
			Vector<String> current_register = new Vector<String>(2);
			current_register.add(0, res.getString(1));
			current_register.add(1,res.getString(2));
			registers.add(current_register);
		}
		desconectar();
		return registers;
	}
